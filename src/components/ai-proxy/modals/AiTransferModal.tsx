      ...
      {transferMode === 'import' ? (
        <div className="space-y-4">
          <div className="bg-black/30 border border-white/10 rounded-lg p-3">
            ...
            <div className="text-xs text-slate-400 mt-1">{t('aiHub.modals.importDescription')}</div>
        ...
        <div className="space-y-4">
          <div className="bg-black/30 border border-white/10 rounded-lg p-3 space-y-3">
            <div>
              <div className="text-sm text-white font-medium">{t('aiHub.modals.exportTitle')}</div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Checkbox
                ...
                onChange={e => {
                  ...
                  if (next) {
                    const ok = window.confirm(t('aiHub.warnings.includeSecretsConfirm'));
                    if (!ok) return;
                  }
