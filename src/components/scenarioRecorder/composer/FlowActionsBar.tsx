...
export function FlowActionsBar({
  ...
  return (
    <div className="flex flex-wrap gap-2">
      <Button variant="secondary" onClick={onAddScenarioStep} disabled={scenariosLoading}>
        + Scenario step
      </Button>
      <Button variant="secondary" onClick={onAddContextStep}>
        + Context step
      </Button>
      <Button variant="secondary" onClick={onAddNextScenarioStep}>
        + Next scenario
      </Button>
