import { t } from "@/lib/i18n";import type { UnifiedGraphDiagnostics } from '@/lib/graph/unifiedGraph';
...
export function IdentityGraphDiagnostics({ diagnostics }: IdentityGraphDiagnosticsProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="text-xs font-semibold uppercase tracking-wider text-slate-300">{t("accounts.identity_graph_diagnostics.graph_diagnostics")}
