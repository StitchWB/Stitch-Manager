          ...
          <div className="flex-1 overflow-y-auto">
            {sessions.map(s => (
              <div
                ...
                className={`group flex items-center gap-2 px-3 py-2 cursor-pointer hover:bg-vsc-hover transition-colors ${s.id === activeSessionId ? 'bg-vsc-blue/10 border-l-2 border-vsc-blue' : ''
                  }`}
              >
