...
export interface Translations {
  ...
  friends: {
    ...
    admin: {
      ...
      fieldType: string;
      fieldBadge: string;
      fieldTgChatId: string;
      fieldTgChatIdHint: string;
      fieldOwner: string;
      fieldOwnerHint: string;
      fieldRoles: string;
      fieldRolesHint: string;
      fieldMaxMembers: string;
      fieldMaxMembersHint: string;
      fieldActive: string;
      save: string;
      saving: string;
      cancel: string;
    ...
    plugins: {
      ...
      submissions: {
        ...
        detail: {
          ...
          attestationPending: string;
          attestationCliHint: string;
          submittedBy: string;
          createdAt: string;
          reviewer: string;
          reviewedAt: string;
...
columnHeader: string;
  ...
  paste: {
    ...
    modelsFound: string;
    modelsAuto: string;
    adapterOpenai: string;
    adapterAnthropic: string;
    alsoAnthropic: string;
    confirm: string;
    creating: string;
    success: string;
