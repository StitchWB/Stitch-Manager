...
export const en: Translations = {
  ...
  ownership: {
    ...
    shareGroupTitle: "Account groups",
    bulkToGroup: "To group",
    groupTooltip: "Groups: {groups}",
    targetGroup: "Target group",
    targetGroupNone: "No group"
  },
  privileges: {
    title: "Privileges",
...
addMailboxFromSheets: "Import from Google Sheets",
  ...
  settings: {
    ...
    community: {
      ...
      pathLabel: "Path",
      manualInstallTitle: "Install from File",
      manualInstallDescription: "Install a package from a local directory or .zip archive. Signed packages are verified into the cache (official); unsigned ones require dev mode and go to plugins-local (local).",
      manualInstallPlaceholder: "C:\\path\\to\\plugin or plugin.zip",
      manualInstallButton: "Install package",
      manualInstallPathRequired: "Enter an absolute path to a package directory or .zip file.",
      manualInstallSuccess: "Package installed",
      manualInstallFailed: "Failed to install package",
      manualInstallDevModeRequired: "Unsigned packages can only be installed in dev mode. Run the backend with STITCH_DEV_MODE=1, or use a signed package.",
      trustOfficialBadge: "official",
      trustLocalBadge: "local"
    },
    overrides: {
      title: "Overrides",
  ...
  aiGateway: {
    ...
    importOpencode: "Import from OpenCode",
    importOpencodeResult: "Imported {providers} providers · {models} models pooled",
    importOpencodeEmpty: "No importable providers found in opencode.json",
  ...
  paste: {
    ...
    title: "Paste Provider Package",
    textareaLabel: "Provider package",
    textareaPlaceholder: "Paste everything they sent you here",
    summaryTitle: "Recognized",
    nothingRecognized: "Nothing recognized — check the package text",
    apiKey: "API key",
    keyMissing: "not found — enter it here",
    modelsLabel: "Models",
    modelsFound: "{count} found",
    modelsAuto: "will be discovered automatically",
    adapterOpenai: "OpenAI",
    adapterAnthropic: "Anthropic",
    alsoAnthropic: "Also add Anthropic format (no /v1)",
    confirm: "Create All",
    creating: "Creating…",
    success: "Created {endpoints} endpoints, discovered {models} models",
    successPending: "Created {endpoints} endpoints, models will be discovered on the next sync",
  },
  status: {
    active: "Active",
  ...
  friends: {
    ...
    myChannel: {
      title: "My channel",
      members: "Members: {count} / {quota}",
      unlimited: "unlimited",
      allowedRoles: "Grant roles",
      inactive: "Inactive",
      hint: "Invite people via the bot: /invite <username_or_id> [role]",
    },
    admin: {
      title: "Partner channels",
      subtitle: "Manage the friends & partner catalog",
      add: "Add channel",
      ...
      deleteMessage: "Delete channel \"{title}\"? Already invited members keep their access.",
      deleteConfirm: "Delete",
      empty: "No partner channels yet",
      loadFailed: "Failed to load partner channels",
      ...
      colType: "Type",
      colBadge: "Badge",
      colMembers: "Invites used",
      colRoles: "Grant roles",
      colQuota: "Quota",
      colOwner: "Owner",
      colStatus: "Status",
      colActions: "Actions",
      ...
      fieldTgChatIdHint: "Numeric chat id, e.g. -1001234567890",
      fieldOwner: "Owner bind",
      fieldOwnerHint: "Numeric Telegram id of the channel admin",
      fieldRoles: "Allowed grant roles",
      fieldRolesHint: "Roles the owner can grant via /invite. Admin and elite are never allowed.",
      fieldMaxMembers: "Invite quota",
      fieldMaxMembersHint: "Codes issuable to this channel; empty = unlimited",
      fieldActive: "Active",
      save: "Save",
      saving: "Saving...",
      cancel: "Cancel",
      errorValidation: "Title and URL are required",
      errorTgChatId: "Telegram chat id must be a number",
      errorOwnerNumeric: "Owner must be a numeric Telegram id",
      errorMaxMembers: "Quota must be a positive number",
      errorRoles: "Select at least one grant role",
    },
  },
  radar: {
    title: "AiApiRadar",
  ...
  marketplace: {
    ...
    submit: {
      ...
      tabRelease: "From release URL",
      tabUpload: "Upload zip",
      pluginId: "Plugin ID",
      pluginIdPh: "my-awesome-plugin",
      version: "Version",
      versionPh: "1.0.0",
      releaseUrl: "Release tarball URL",
      ...
      domainsHint: "Comma or space separated. Scenario goto steps may only navigate to these hosts.",
      zip: "Plugin zip (max 5 MB)",
      pickZip: "Choose file",
      zipDesktopOnly: "Zip upload is available in the desktop app only",
      zipTooLarge: "Zip exceeds the 5 MB limit",
      submit: "Submit",
      submitting: "Submitting...",
      success: "Submission #{id} sent — pending review",
      failed: "Submission failed",
      gateFailures: "Auto-checks failed",
      requiredFields: "Plugin ID and version are required",
      requiredRelease: "Release URL and SHA256 are required",
      requiredZip: "Choose a zip file",
      invalidSha: "SHA256 must be 64 hex characters",
    },
    mySubmissions: {
      tab: "My submissions",
      ...
      emptyDesc: "Use the \"Submit plugin\" button to send your first plugin for review",
  ...
  ai: {
    groups: {
      ...
      accountsEmpty: "No accounts in this group yet",
      accountsHint: "Accounts shared into the group by members.",
      removeShare: "Remove from group",
      search: {
      ...
      quotas: {
        title: "Quotas",
        empty: "No quota rules — the group pool is unlimited",
        addRule: "Add rule",
        scopeMember: "Per member",
        scopePool: "Whole group",
        everyone: "Everyone",
        wholePool: "Shared pool",
        modelLabel: "Model",
        modelPh: "glm-5.2 or glm-* — empty = all models",
        unitLabel: "Unit",
        unitRequests: "Requests",
        unitTokens: "Tokens",
        amountLabel: "Amount",
        amountPh: "empty = unlimited",
        periodLabel: "Period",
        periodDaily: "Per day",
        periodTotal: "Total",
        unlimited: "Unlimited",
        ...
        saved: "Quota rule saved",
        deleted: "Quota rule deleted",
        invalidAmount: "Amount must be a whole positive number or empty",
      },
      pool: {
        title: "Key pool",
  ...
  admin: {
    plugins: {
      ...
      accessByGroupDesc: "Grant private plugins to groups — every group member may download them",
      ...
      noGroupsDesc: "Create a group to grant plugins to its members",
      ...
      servicePlugin: {
        metrics: {
          ...
          command: "Command",
          noCommands: "No commands called yet",
      ...
      installFromSource: {
        ...
        url: "Source URL (git repository)",
        mode: "Install mode",
        repoRef: "Git ref (branch/commit)",
        releaseTag: "Release tag",
        sha256: "SHA256 (optional)",
        trust: "Trust source (skip signature check)",
        submit: "Install",
        success: "Plugin installed: {id} v{version}",
        failed: "Failed to install plugin",
      },
      submissions: {
        tab: "Submissions",
        title: "Plugin submissions",
        desc: "Moderation queue for community plugin submissions",
        refresh: "Refresh",
        statusFilter: "Status",
        ...
        emptyDesc: "The moderation queue is empty",
        ...
        detail: {
          ...
          gates: "Gate report",
          noGates: "No gate report",
          domains: "Declared domains",
          noDomains: "No domains declared",
          sha256: "SHA256",
          sourceUrl: "Source URL",
          files: "Package files",
          noFiles: "No package stored",
          attestation: "Attestation",
          attestationSigned: "Signed by {reviewer} at {date}",
          attestationPending: "Pending — offline signature not uploaded yet",
          attestationCliHint: "run: python -m stitch_plugin_tools attest --server <url> --submission {id} --reviewer <name>",
          submittedBy: "Submitter",
          createdAt: "Created",
          reviewer: "Reviewer",
          reviewedAt: "Reviewed",
          rejectionReason: "Rejection reason",
          loadFailed: "Failed to load submission detail",
        },
        actions: {
          approve: "Approve",
          approveTitle: "Approve submission",
          approveMessage: "Re-run all gates and publish {plugin}@{version} to the community catalog?",
          reviewer: "Reviewer",
          reject: "Reject",
          rejectTitle: "Reject submission",
          rejectReason: "Reason (required)",
          rejectReasonPh: "Why is this submission rejected?",
          delist: "Delist",
          delistTitle: "Delist submission",
          delistMessage: "Hide {plugin}@{version} from the catalog? Installed copies keep working (TOFU), updates are refused.",
          success: "Submission updated",
          failed: "Action failed",
        },
        badges: {
          title: "Badges",
          hint: "Manual badges for the approved plugin. Works and Not works are mutually exclusive.",
          recommended: "Recommended",
          works: "Works",
          notWorks: "Not works",
          verified: "Verified",
          verifiedComputed: "Computed server-side from the offline attestation — not settable manually",
          save: "Save badges",
          saved: "Badges updated",
          saveFailed: "Failed to update badges",
        },
      },
      sandbox: {
        title: "Developer sandbox",
        subtitle: "Your private per-user plugins — install, run, inspect, call",
        loadFailed: "Failed to load sandbox plugins",
        empty: "No sandbox plugins installed",
        emptyDesc: "Install a plugin from your git repo to test it in your private sandbox",
        restartSuccess: "Sandbox plugin restarted",
        restartFailed: "Failed to restart sandbox plugin",
        uninstallSuccess: "Sandbox plugin uninstalled",
        uninstallFailed: "Failed to uninstall sandbox plugin",
        uninstallConfirmTitle: "Uninstall sandbox plugin",
        uninstallConfirmMessage: "Uninstall \"{id}\" from your sandbox? This stops the host and removes its package, data and pin.",
        install: {
          url: "Git URL",
          ref: "Ref (branch/tag/SHA, optional)",
          sha256: "SHA256 (optional)",
          trust: "Trust source (bypass dev gate)",
          urlRequired: "Git URL is required",
          submit: "Install",
          forceInstall: "Force install",
          success: "Installed {id}@{version} (pin {sha})",
        },
        status: {
          running: "Running",
          stopped: "Stopped",
        ...
        playground: {
          ...
          invalidJson: "Params must be a valid JSON object",
          networkError: "Request failed — backend unreachable",
          response: "Response",
          error: "Error",
          idleHint: "First call after idle may take a moment (the host starts on demand).",
          shadowHint: "For you, this sandbox plugin shadows any global plugin with the same id.",
        },
      },
    },
    userProfile: {
