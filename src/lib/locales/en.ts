...
addMailboxFromSheets: "Import from Google Sheets",
  ...
  paste: {
    ...
    previewTitle: "What will be created",
    nothingRecognized: "Nothing recognized — check the package text",
    apiKey: "API key",
    noKeyWarning: "No key found — enter it manually, otherwise endpoints are created without a credential",
    credentialLabel: "Credential label",
    modelsLabel: "Models (comma-separated)",
    confirm: "Create All",
    creating: "Creating…",
    success: "Created {endpoints} endpoints, {models} models",
  },
  status: {
    active: "Active",
