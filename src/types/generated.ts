...
export type PythonAutoregResult = { success: boolean; email: string | null; password: string | null; tokenFile: string | null; token: string | null; refreshToken: string | null; error: string | null; name: string | null }
...
export type PoolConfig = { switchStrategy: string; autoRefreshEnabled: boolean; switchOnError: boolean; switchOnRateLimit: boolean; maxErrorsBeforeBan: number }

/**
 * Registration status for tracking ongoing registration processes
 */
export type RegistrationStatus = { isRunning: boolean; success: boolean | null; status: string | null; provider: string | null; email: string | null; step: string | null; progress: number | null; error: string | null; startedAt: string | null }
