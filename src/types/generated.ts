...
export type PythonAutoregConfig = { email: string | null; name: string | null; password: string | null; headless: boolean; deviceFlow: boolean; autoGenerate: boolean; imapServer: string; imapPort: number | null; imapUser: string; imapPassword: string; emailStrategy: string | null; proxyUrl: string | null; speedMultiplier: number | null; verificationCodeTimeout: number | null; oauthCallbackTimeout: number | null; allowAccessWait: number | null; pageLoadTimeout: number | null; elementWaitTimeout: number | null; imapPollInterval: number | null; passwordLength: number | null; realisticTyping: boolean | null; humanDelays: boolean | null; screenshotsOnError: boolean | null; addyioEnabled: boolean | null; addyioApiToken: string | null; addyioDomain: string | null; addyioAliasFormat: string | null; addyioAutoDelete: boolean | null; thirtyThreeMailEnabled: boolean | null; thirtyThreeMailUsername: string | null; thirtyThreeMailDomain: string | null; mailtmEnabled: boolean | null; icloudPoolEnabled: boolean | null; inboxProvider: string | null; inboxMailbox: string | null; inboxMailtmAddress: string | null; inboxMailtmPassword: string | null; inboxMailtmBaseUrl: string | null; launchProfileAlias: string | null; launchMode: string | null; awsBootstrapAccountId: number | null; correlationId: string | null }

export type ICloudPoolEntry = { id: number; email: string; appleAliasId: string | null; label: string | null; status: string; appleId: string | null; usedByAccountId: string | null; createdAt: string; reservedAt: string | null; usedAt: string | null }

export type ICloudPoolStats = { total: number; available: number; reserved: number; used: number; failed: number; deleted: number; rateRemaining: number; rateSecondsUntilSlot: number }
