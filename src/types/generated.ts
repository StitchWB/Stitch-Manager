...
export type PoolConfig = { switchStrategy: string; autoRefreshEnabled: boolean; switchOnError: boolean; switchOnRateLimit: boolean; maxErrorsBeforeBan: number; customThreshold: number | null }
