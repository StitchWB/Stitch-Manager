...
class DebugRecorder:
    ...
    def __init__(self, session_name: str | None = None, output_dir: str | None = None):
        """
        Args:
    ...
    def record_page_html(self, page, name: str | None = None):
    ...
    def _take_screenshot(self, page, name: str) -> Path | None:
        """Делает скриншот"""
        try:
...
# Глобальный рекордер
_recorder: DebugRecorder | None = None
...
def init_recorder(session_name: str | None = None) -> DebugRecorder:
...
def record(action_type: str, details: dict | None = None, page=None, screenshot: bool = True):
