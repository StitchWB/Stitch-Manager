...
class SessionStore:
    ...
    def list_sessions(self, provider: Optional[Provider] = None) -> List[SessionData]:
        """
...
class SessionManager:
    ...
    def __init__(
        ...
        rust_callback: Optional[Callable[[str, Dict[str, Any]], None]] = None
    ):
        """
    ...
    def get_active_sessions(self, provider: Optional[Provider] = None) -> List[SessionData]:
